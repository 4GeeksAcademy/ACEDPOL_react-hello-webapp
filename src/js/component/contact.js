        ...
        <div className="d-flex justify-content-center border-bottom py-3 px-3">
            ...
            <div className="ms-5 w-100">
                <div className="d-flex justify-content-between align-items-center mb-2">
                    <h5 className="fw-bold text-black m-0">Complete Name</h5>
                ...
                <div className="text-black-50 d-flex align-items-center">
                    ...
                    <p className="m-0">5842 Hillcrest Road</p>
                </div>
                <div className="text-black-50 d-flex align-items-center">
                    <i className="fa-solid fa-phone-flip mx-2"></i>
                    <p className="m-0">(870) 288-4149</p>
                </div>
                <div className="text-black-50 d-flex align-items-center">
                    <i className="fa-solid fa-envelope mx-2"></i>
                    <p className="m-0">mike.ana@example.com</p>
                </div>                
            </div>
        </div>
    </section>
